...
export default function About() {
  return (
    <div className='abt'>
     <p>Welcome to our travel page, your gateway to discovering unforgettable destinations and experiences around the world. Here, we bring together inspiring stories, expert guides, and practical tips to help you plan journeys that are as seamless as they are memorable. Whether you’re drawn to the serene beauty of tropical beaches, the cultural richness of historic cities, or the thrill of adventure in the great outdoors, our page is designed to spark your wanderlust and guide you every step of the way.
